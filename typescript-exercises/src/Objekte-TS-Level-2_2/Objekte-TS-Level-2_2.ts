...
sortedSingers.sort((a, b) => a.name.localeCompare(b.name));

console.log(sortedSingers);

const sortedSingers2 = [...singers];

// Sortiere anschließend die Bands aufsteigend nach dem Karrierebeginn (period_active.start).

sortedSingers2.sort((a, b) => a.period_active.start - b.period_active.start);

console.log(sortedSingers2);
